...
from spycelib.block import Block, isBlock, getBlock, gridPos
from spycelib.text  import textItem, Comment, isComment
from spycelib.port  import Port, isInPort, isOutPort, isNode, isPort
from spycelib.connection import Connection, isConnection
# from spycelib.dialg import RTgenDlg, error
from spycelib.dialg import error

from spycelib.const import pyrun, netlist_dir, DB
import libraries
...
#        c.update_ports_from_pos()
    ...
    #
    #     items = list(self.items())
    #     txt += 'from spycelib.RCPblk import *\n'
    #     txt += 'try:\n'
    #     txt += '    from spycelib.dsPICblk import *\n'
    #     txt += 'except:\n'
    #     txt += '    pass\n'
    #     txt += 'from spycelib.RCPgen import *\n'
