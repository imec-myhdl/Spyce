...
from spycelib.port import Port, isInPort, isOutPort, isPort, isNode
from spycelib.connection import Connection, isConnection
from spycelib.block import isBlock, gridPos, getBlock
from spycelib.text  import textItem, Comment, isTextItem, isComment
from spycelib.dialg import BlockName_Dialog, textLineDialog, overWriteNetlist, \
                           error, propertiesDialog, selectionDialog
# import spycelib.RCPDlg as pDlg
from spycelib.const import DB, colors, viewTypes
import libraries
                ...
                if item.hasDiagram():
                    ...
                    if 'myhdl' in views:
                        ...
                        if ret == 0:
                            ...
                            overwrite = False
                    if overwrite:
                        import spycelib.netlist
                        content = spycelib.netlist.netlistMyHdl(item.blockname,item.libname,item.properties)
                        if content == False:
