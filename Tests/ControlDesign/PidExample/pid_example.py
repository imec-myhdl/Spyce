...
g=tf([1],[1,6,5])
bode(g,dB=True);
plt.subplot(211), plt.legend(['G(s)'],prop={'size':10})
plt.show()
...
plt.hold
bode(Gpi*g,dB=True);
plt.subplot(211), plt.legend((['G(s)','Gpi(s)*G(s)']),prop={'size':10})
plt.show()
...
plt.subplot(211), plt.legend((['G(s)','Gpi(s)*G(s)','Gpi(s)*GLead(s)*G(s)']),prop={'size':10})
plt.show()
...
plt.subplot(211),plt.legend((['G(s)','Gpi(s)*G(s)','Gpi(s)*GLead(s)*G(s)','K*Gpi(s)*GLead(s)*G(s)']),prop={'size':10})
plt.show()
